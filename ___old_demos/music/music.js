...
export class MusicExtension extends React.Component
{
	//	static contextType = AzureThemeContext;
	static defaultProps = {
		Title: "Music by The Drive Through",
		LinkTitle: "Music",
		Href: "/music/"
	};
	constructor( props )
	{
		...
		this.Title = ( this.props.Title || MusicExtension.defaultProps.Title );
		this.LinkTitle = ( this.props.LinkTitle || MusicExtension.defaultProps.LinkTitle );
		this.Href = ( this.props.Href || MusicExtension.defaultProps.Href );
		return;
	};
	render()
