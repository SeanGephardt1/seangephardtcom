...
function Prototype_ViewModel( demoName, debugFlag  )
{
	...
	this.AppGateWayExtension = new ApplicationGateway_ViewModel( _self, "Extension Feature", SVG.Color.ApplicationGateways_color );
	...
	this.LeftNavOpenClose = ko.observable( true );
	...
	this.parseQueryString = ko.computed(function ()
	{
		...
		//	console.debug( "this.FeatureFlags", this.FeatureFlags() );
		return;
	}, this);
	...
	// FOR MARKETPLAEC/SMART DEFAULTS TESTING
	//this.NewMarketPlace.SelectedDetailsPage( new MarketplaceResult_ViewModel( _self, _market_place_data_scrubbed[0]) );
	//this.NewMarketPlace.DetailsPageDisplayed( true );
	//this.CurrentExtensionViewModel( this.NewMarketPlace );
	return;
};