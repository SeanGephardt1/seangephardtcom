...
import './azure-spinner.css';
class AzureProgressSpinnerControl extends React.Component
{
	static defaultProps = {
		Sizes:
		{
	...
	{	
		super( props );
		this.Size = ( this.props.size || AzureProgressSpinnerControl.defaultProps.Sizes.Large );
		return;
	};
	render()
	{	//	console.debug( "AzureProgressSpinnerControl.render()", this.props.size );	
		return (
...
export
{
	AzureProgressSpinnerControl as AzureProgessSpinner
};