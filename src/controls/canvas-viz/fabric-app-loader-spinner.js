...
class AzureLoadingControl extends React.Component
{
	constructor( props )
	{
		super( props );
	...
	render()
	{	//	console.debug( "FabricSpinnerAppLoaderControl.render()", this.props.config );
		return (
			<div className="app-loader-panel">
				...
				{/* show Spinner */}
				{
					( this.props.config.ShowSpinner === true ) &&
					<div className="fabric-spinner-prog-circle">
						<AzureProgessSpinner size={AzureProgessSpinner.defaultProps.Sizes.Small} />
					</div>
				}
...
export
{
	AzureLoadingControl as AzureLoader
};