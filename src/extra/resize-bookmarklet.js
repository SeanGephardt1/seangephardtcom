javascript: (function () {
  ...
  if (constrastletelem == null) {
    ...
    const mouseMoveHandler = function (e) {
      ...
      // contrastletdragable.style.top = % 60${ contrastletdragable.offsetTop + dy } px % 60;
      // contrastletdragable.style.left = % 60${ contrastletdragable.offsetLeft + dx } px % 60;
      contrastletdragable.style.top = "100px";
      contrastletdragable.style.left = "100px";
      x = e.clientX;
      y = e.clientY;
      return;
    };
