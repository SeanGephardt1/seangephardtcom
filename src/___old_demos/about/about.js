...
export class AboutExtension extends React.Component
{
	static defaultProps = {
	...
	constructor( props )
	{
		...
		this.Title = ( this.props.Title || AboutExtension.defaultProps.Title );
		this.LinkTitle = ( this.props.LinkTitle || AboutExtension.defaultProps.LinkTitle );
		this.Href = ( this.props.Href || AboutExtension.defaultProps.Href );

		return;
	};
	render()
	{	//	console.debug( "AboutExtension.render()", this.context );	
		return (
